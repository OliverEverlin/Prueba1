...
cap = cv.VideoCapture("Johan/video.mp4")
...
while cv.waitKey(1) < 0:
    ...
    if points[0] is not None or points[1] is not None:
        ...
        respaldo = angulo_cabeza
    else:
        angulo_cabeza = respaldo
    
    print(angulo_cabeza)
    angulos.append((int(j),int(angulo_cabeza)))
    j = j+1
...
angulos.to_excel("Johan/pp.xlsx",sheet_name = 'pag',engine = 'openpyx1')
